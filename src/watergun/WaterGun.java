...
public class WaterGun {
    ...
    public static void main(String[] args) {
       System.out.println("\t~ BIENVENIDOS A LA RULETA DE AGUA ~");
        JuegoService gameService = new JuegoService();
        List<Jugador> jugadoresList = new ArrayList();
        Revolver revolver = new Revolver();
        
        gameService.llenarJuego(jugadoresList, revolver);
        gameService.ronda(jugadoresList, revolver);
    }
